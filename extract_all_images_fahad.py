#!/usr/bin/env python3
"""
Extract all images from Fahad Alsuhibani PPTX file with numbering.
"""
...
def main():
    pptx_file = "/mnt/d/repos/MOE-region-employees/slides/Welcome onboard - Fahad Alsuhibani.pptx"
    ...
    if images:
        ...
        print("\nPlease review the images and identify which number is the profile picture for Fahad Alsuhibani.")
        return True
    else:
